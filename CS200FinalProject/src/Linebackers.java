...
public class Linebackers extends Defense{
    ...
    public Linebackers(String name, int tackles_, int ast, int sacks_, int ydsl, int tloss, int pd, int intercept, int yds, int longest_, int pick, int ff, int rec, int ff_td, int bk  ){
